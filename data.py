...
def make_tag_set(tag_set, relation_label):
    ...
    for pos in "BIES":
        for role in "12":
            ...
            #print("-".join([pos, relation_label, role]))
...
if __name__ == "__main__":
    ...
    with open("overlap.txt", "wt", encoding="utf-8") as fout:
        ...
        save(test, 'data/new/test.pk')

    relation_labels.save('data/new/relation_labels.txt')
    entity_labels.save('data/new/entity_labels.txt')
    tag_set.save("data/new/tag2id.txt")
