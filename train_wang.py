...
# val_data : <torch.utils.data.dataset.Subset object at 0x7f3b5c942828>
print("len(train_data) =" + str(len(train_data)))
print("len(val_data) =" + str(len(val_data)))


# torch.Size([47463, 300])
# breakpoints:[10, 20, 30, 40, 50, 60]
...
train_data_groups = group(train_data, [10, 20, 30, 40, 50, 60])  # 2148
val_data_groups = group(val_data, [10, 20, 30, 40, 50, 60])  # 716
test_data_groups = group(test_data, [10, 20, 30, 40, 50, 60])  # 722
...
if __name__ == "__main__":
    ...
    try:
        ...
        for epoch in range(1, args.epochs + 1):
            train()
            # val_loss, precision, recall, f1 = evaluate(train_data_groups)
